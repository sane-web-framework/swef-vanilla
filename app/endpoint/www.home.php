...
<h2><?php echo htmlspecialchars('This is file '.__FILE__.' speaking!').'<br/>'.SWEF_STR__CRLF; ?></h2>
...
<div class="monospace">
  ...
  <p>Translation is TO the language for the current context: $this->swef->context[SWEF_COL_LANGUAGE] = <?php echo htmlspecialchars($this->swef->context[SWEF_COL_LANGUAGE]); ?></p>
